...
public class SimpleServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		out.println("<div class=\"row\" id=\"first\"><div class=\"col-sm-6\"><img src=\"smajlici.jpg\" class=\"img-rounded\" /></div>"
		...
		if(name.trim()=="" || surname.trim()=="" || dateOfBirth.trim()=="" || phoneNumber.trim()==""
			...
			out.println("<p class=\"bold-p\">Niste dobro ispunili prijavu, vratite se nazad.</p><br/></div>");
			
		}else{
			out.println("<p class=\"bold-p\">Uspjesno ste poslali Vase podatke.</p><br/>");
			...
			out.println("<p><img src=\"takesmile.png\" class=\"img-rounded\" alt=\"take a smile\""
					+ "align=\"left\" width=\"300\" height=\"100\" /></p>"
					+ "<br/><br/>");
		}
