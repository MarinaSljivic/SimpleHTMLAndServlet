...
public class SimpleServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if(name.trim()=="" || surname.trim()=="" || dateOfBirth.trim()=="" || phoneNumber.trim()==""
			...
			out.println("<div class=\"paragrafi\"><p>Niste dobro ispunili prijavu, vratite se nazad.</p><br/></div>");
			
		}else{
			out.println("<div class=\"paragrafi\"><p>Uspjesno ste poslali Vase podatke.</p><br/></div>");
